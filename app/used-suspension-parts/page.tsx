  ...
  return (
    <>
      ...
      <main className="pt-[58px]">
        {/* Header */}
        <div className="relative border-b border-border/30 bg-cover bg-center" style={{ backgroundImage: "linear-gradient(to bottom right, rgba(13,15,22,0.92), rgba(13,15,22,0.72), rgba(13,15,22,0.95)), url('/images/heroes/hero-suspension.png')" }}>
