          ...
          {selectedMake && (
            <div className="glass-card rounded-lg p-4 sm:p-8 mb-8 sm:mb-12">
              ...
              <div className="flex gap-3 mt-8 flex-wrap">
                ...
                <a href="tel:18778406741" className="inline-flex items-center justify-center gap-2 px-5 py-3 text-[0.65rem] font-bold tracking-[0.18em] uppercase border border-border/60 text-muted-foreground rounded-sm hover:border-foreground/50 hover:text-foreground transition-all">
                  <Phone className="w-3 h-3" /> Call (877) 840-6741
                </a>
              </div>
            </div>
          )}
