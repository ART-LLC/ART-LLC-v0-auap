  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background">
        {/* Hero Banner */}
        <HeroBanner
          title="Transmission Parts & Components"
          subtitle="High-quality used transmissions and components. Automatic, manual, CVT, and all components for reliable performance."
          pathname="/parts/transmissions"
        />
