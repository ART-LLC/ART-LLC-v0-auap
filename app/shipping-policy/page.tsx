  ...
  return (
    <>
      ...
      <main className="pt-[58px]">
        <div className="relative border-b border-border/20 bg-cover bg-center py-16" style={{ backgroundImage: "linear-gradient(to bottom right, rgba(13,15,22,0.93), rgba(13,15,22,0.78), rgba(13,15,22,0.96)), url('/images/heroes/hero-salvage.png')" }}>
