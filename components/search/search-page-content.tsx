        ...
        <div className="mx-auto max-w-[1100px] px-4 sm:px-6 pb-6 sm:pb-8">
          <div className="glass-card rounded-xl overflow-hidden">
            <div className="px-4 sm:px-6 py-3 border-b border-border/20 flex items-center justify-between">
              ...
              <a href="tel:18778406741" className="text-[10px] sm:text-[11px] text-muted-foreground hidden sm:block">
                <Phone className="w-3 h-3 inline mr-1" /> (877) 840-6741
              </a>
            </div>
            <div className="p-4 sm:p-7">
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex gap-3 flex-wrap">
                  ...
                  <a href="tel:18778406741" className="inline-flex items-center justify-center gap-2 px-6 py-4 text-[0.7rem] font-bold tracking-[0.18em] uppercase border border-border/60 text-muted-foreground rounded-lg hover:border-foreground/50 hover:text-foreground transition-all">
        ...
        {searched && !loading && results.length === 0 && (
          <div className="text-center py-16">
            ...
            <div className="flex gap-3 justify-center flex-wrap">
              <a href="tel:18778406741" className="btn-led inline-flex items-center justify-center gap-2 px-5 py-3 text-[0.68rem] font-bold tracking-[0.18em] uppercase rounded-sm">
        ...
        {searched && !loading && results.length > 0 && (
          <>
                ...
                <div key={r.id} className="glass-card rounded-lg p-4 sm:p-6 flex flex-col gap-4 sm:gap-6 transition-all hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-[0_8px_40px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-between shrink-0 sm:min-w-[140px] pt-3 sm:pt-0 border-t sm:border-t-0 border-border/20">
                    ...
                    <div className="flex gap-2 sm:mt-4">
                      ...
                      <a href="tel:18778406741" className="inline-flex items-center justify-center gap-1.5 px-4 py-2 text-[10px] font-bold tracking-[0.15em] uppercase border border-border/60 text-muted-foreground rounded-sm hover:border-foreground/50 hover:text-foreground transition-all">
                        Call
                      </a>
                    </div>
                  </div>
            ...
            <div className="text-center mt-10 pt-8">
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                <a href="tel:18778406741" className="btn-led inline-flex items-center justify-center gap-2 px-5 py-3 text-[0.68rem] font-bold tracking-[0.18em] uppercase rounded-sm">
                  <Phone className="w-3.5 h-3.5" /> Call (877) 840-6741
                </a>
                <Link href="/quote" className="w-40 inline-block hover:-translate-y-1 transition-transform duration-200">
                  <img src="/images/button-request-free-quote.png" alt="Request Free Quote" className="w-full h-auto drop-shadow-lg" />
                </Link>
