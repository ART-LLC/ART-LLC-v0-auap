...
const SIZES: Record<BrandSize, SizeCfg> = {
  ...
  "hero-5xl": { wordmarkSize: "text-[clamp(6rem,20vw,15rem)]", subSize: "text-[clamp(1.2rem,2.6vw,2rem)]",       tagSize: "text-[clamp(1rem,2.4vw,1.6rem)]",      showSub: true,  showTag: true,  align: "items-center" },
}
