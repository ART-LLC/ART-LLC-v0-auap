    ...
    <section className="relative pt-[58px] overflow-hidden ghost-scan-section" style={{ paddingTop: "45px" }}>
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-4 sm:px-6">
        <div className="flex flex-col items-center py-10 sm:py-16 lg:py-24 gap-8 sm:gap-10">
          ...
          >
            {/* Logo + Wordmark — MASSIVE brand block */}
            <div className="flex flex-col items-center gap-8 sm:gap-10 w-full py-6">
              {/* Gigantic logo */}
              <Logo size="3xl" variant="medallion" priority showGlow />
              {/* Massive wordmark */}
              <BrandWordmark size="hero-xl" className="text-center items-center" />
            </div>
